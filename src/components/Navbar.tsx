      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-[72px] z-40 lg:hidden bg-bg-clinic/95 backdrop-blur-lg flex flex-col justify-between p-8 border-t border-primary/10 shadow-premium-lg"
          >
